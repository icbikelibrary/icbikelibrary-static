jQuery(function ($) {
  ...
  var birdseyeController = {
    init: function (opts) {
      ...
      if (
        !$("body").hasClass("wsite-editor") &&
        $("#wsite-nav-cart-a").length
      ) {
        $("#wsite-nav-cart-a").html(
          $("#wsite-nav-cart-a").html().replace(/[()]/g, ""),
        );
      }
      ...
      $(".wsite-menu-default")
        ...
        .each(function () {
          ...
          if ($me.children(".wsite-menu-wrap").length > 0) {
            ...
            $('<span class="icon-caret"></span>').insertAfter(
              $me.children("a.wsite-menu-item"),
            );
          }
        });
      ...
      $(".wsite-menu")
        ...
        .each(function () {
          ...
          if ($me.children(".wsite-menu-wrap").length > 0) {
            $me.addClass("has-submenu");
            $('<span class="icon-caret"></span>').insertAfter(
              $me.children("a.wsite-menu-subitem"),
            );
          }
        });
    ...
    _attachEvents: function () {
      ...
      // Move Cart
      $.fn.intervalLoop(
        ".birdseye-header #wsite-mini-cart",
        base._moveCart,
        300,
        8,
      );
